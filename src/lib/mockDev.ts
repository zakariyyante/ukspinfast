...
export const mockLandingPages: ApiLandingPage[] = [
  {
    id: "lp-1",
    headText: "Best UK Online Casinos 2026",
    headParagraph: "Discover the top-rated online casinos in the UK. Safe, secure, and fully licensed. Get the best bonuses and start playing today!",
    pageTitle: "Top UK Online Casinos | UK Play Casino",
    isActive: true,
    order: 1,
  },
];
