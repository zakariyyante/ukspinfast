      ...
      <div className="max-w-2xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          <div className="p-6 rounded-2xl bg-panel border border-border">
            ...
            <a href="mailto:support@topspinuk.com" className="text-lg font-medium hover:text-primary transition-colors">support@topspinuk.com</a>
          </div>
          <div className="p-6 rounded-2xl bg-panel border border-border">
            ...
            <a href="mailto:partners@topspinuk.com" className="text-lg font-medium hover:text-primary transition-colors">partners@topspinuk.com</a>
          </div>
        </div>
