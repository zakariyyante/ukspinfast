  ...
  return (
    <div className="container mx-auto px-4 py-20">
      ...
      <div className="max-w-4xl prose prose-invert">
        ...
        <p className="mb-6">
          Under the GDPR and data protection laws, you have the right to access, rectify, or erase your personal data. Contact us if you wish to exercise these rights.
        </p>
      </div>
    </div>
  );
