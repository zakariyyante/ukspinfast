  ...
  return (
    <div className="container mx-auto px-4 py-20">
      ...
      <div className="max-w-4xl prose prose-invert">
        ...
        <p className="mb-6">
          By accessing and using topspinuk.com, you agree to be bound by these Terms and Conditions. If you do not agree with any part of these terms, you must not use our website.
        </p>

        <h2 className="text-2xl font-bold mb-4">2. Age Restriction</h2>
        <p className="mb-6">
          You must be at least 18 years of age to use this website. By using this website, you warrant and represent that you are at least 18 years old. We strictly adhere to UK gambling regulations.
        </p>

        <h2 className="text-2xl font-bold mb-4">3. Affiliate Disclosure</h2>
        <p className="mb-6">
          topspinuk.com is an affiliate marketing website. We receive commissions from the casino operators listed on our site when users click on our links and sign up. This does not affect the cost to you as a player.
        </p>
