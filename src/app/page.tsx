...
export default async function Home({
  ...
  return (
    <div className="flex flex-col">
      <Hero 
        headText={landingPage?.headText || "Best UK Online Casinos"} 
        headParagraph={landingPage?.headParagraph || "Discover top-rated UK casinos with exclusive bonuses."} 
      />
      ...
      <section className="py-20 bg-panel/20 border-y border-border">
        <div className="container mx-auto px-4">
          <div className="mb-16 text-center">
            <h2 className="text-3xl font-bold md:text-5xl mb-4">Why Trust <span className="text-primary">TopSpinUK</span>?</h2>
            <p className="text-foreground/60 max-w-2xl mx-auto">We provide transparent, data-driven reviews to help you find the safest and most rewarding gaming experiences in the UK.</p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              { icon: ShieldCheck, title: "UKGC Licensed", desc: "Every casino we list is fully regulated by the UK Gambling Commission." },
              ...
              { icon: Users, title: "Player Reviews", desc: "Real feedback from real UK players to guide your choice." }
            ].map((item, i) => (
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-invert">
            <h2 className="text-3xl font-bold mb-6">The Ultimate Guide to Online Casinos in the UK</h2>
            <p className="mb-4">
              Finding the right online casino can be a daunting task, especially with the vast number of options available to UK players. At TopSpinUK, we simplify this process by providing comprehensive reviews and up-to-date information on the best platforms in the industry.
            </p>
            <h3 className="text-2xl font-bold mb-4">What to Look for in a UK Online Casino</h3>
            <ul className="list-disc pl-6 mb-6 space-y-2 text-foreground/80">
              <li><strong>Licensing:</strong> Always ensure the casino holds a valid UKGC license.</li>
              ...
              <li><strong>Payment Methods:</strong> The best casinos offer multiple secure options, including debit cards, e-wallets like PayPal, and bank transfers.</li>
